...
> ⚠️ **状态:已废弃(dbs-content-system 0X-07 目录已 gitignore,不在开源版本中)**。
> monorepo v1.0.0 已经从「内容结构化系统」迁移到「组件化流水线」([AGENTS.md](./AGENTS.md))。
> 本文件保留作为个人内容资产管理方法的历史快照,新贡献者请忽略。
> 
> 当需要定位来源、判断处理状态、确认主单元、解决重复冲突时,请读 [AGENTS.md](./AGENTS.md)。
