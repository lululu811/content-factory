...
Example:
    >>> from content_factory.cninfo import download_pdf, download_pdfs
    >>> # Single download
    ...
    >>> from content_factory.cninfo import get_announcements
...
def download_pdfs(
    ...
    *,
    ...
    Examples:
        >>> from pathlib import Path
        >>> from content_factory.cninfo import get_announcements, download_pdfs
        >>> anns = get_announcements("600487.SH", days=14)
